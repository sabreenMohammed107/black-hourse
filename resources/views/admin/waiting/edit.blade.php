...
<!-- form start -->
<form action="{{route('waiting.update',$row->id)}}"  method="post" enctype="multipart/form-data">
    @method('PUT')
    @csrf
<div class="box-body">
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="student_id" id="student_id" style="width: 100%;">
                        ...
                        <option value="{{$all->id}}" {{ $row->student_id == $all->id ? 'selected' : '' }}>{{$all->name}}</option>
                        @endforeach
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="tel" name="mobile2" value="{{$row->student->mobile2??''}}" class="form-control" id="">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <select class=" select2 dynamic form-control" name="course_id" id="course_id">
                        ...
                        <option value="{{$type->id}}" {{ $row->course_id == $type->id ? 'selected' : '' }}> {{$type->name}}</option>
                        @endforeach
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="date" name="invoice_date" value="{{date('Y-m-d', strtotime($row->invoice_date))}}" class="form-control">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="">المبلغ المطلوب </label>
                    <input type="number" name="total_required_fees" onchange="myFunction()" value="{{$row->total_required_fees}}" class="form-control" id="total_required_fees">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="">المبلغ المدفوع </label>
                    <input type="number" name="total_fees_new" onchange="myFunction()" value="{{$row->total_fees_new}}" class="form-control" id="total_fees_new">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="">المبلغ المتبقى </label>
                    <input type="number" name="remian" value="{{$row->total_required_fees - $row->total_fees_new}}" readonly class="form-control" id="remian">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="">المواعيد المناسبة</label>
                    <input type="text" name="contact_times" value="{{$row->student->contact_times ?? ''}}" class="form-control">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="">التاريخ المناسب للتواصل </label>
                    <input type="date" name="contact_date" value="{{date('Y-m-d', strtotime($row->student->contact_date))}}" class="form-control" id="">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
