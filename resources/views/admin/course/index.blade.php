...
<div class="box">
    <div class="box-header">
        ...
        <a href="{{ route('course.create') }}" class="btn btn-info btn-lg pull-right"> اضافة </a>
            ...
            data-show-export="true" data-locale="ar-SA"  style="direction: rtl" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('course.show', $row->id) }}" class="btn btn-default"><i class="fa fa-eye" title="عرض"></i></a>
                                            <a href="{{ route('course.edit', $row->id) }}" class="btn btn-default"><i class="fa fa-edit" title="تعديل"></i></a>
