...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            ...
            <a href="{{ route('deploma.create') }}" class="btn btn-info btn-lg pull-right"> اضافة </a>
                    ...
                    <tbody>
                        @foreach ($rows as $index => $row)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('deploma.show', $row->id) }}" class="btn btn-default"><i
                                                class="fa fa-eye" title="عرض"></i></a>
                                        <a href="{{ route('deploma.edit', $row->id) }}" class="btn btn-default"><i
                                ...
                                <div class="modal modal-danger" id="del{{ $row->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <form action="{{ route('deploma.destroy', $row->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
