    ...
    <div class="box-body">
        ...
        <h3 class="card-title float-sm-left"><a href="" class="btn btn-success" data-toggle="modal"
            data-target="#add-tabdeploma">إضافة</a></h3>
            ...
            data-show-export="true" data-locale="ar-SA"  style="direction: rtl" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                              <button type="button" class="btn btn-default" data-toggle="modal" data-target="#delcoursedeploma{{ $course->id }}"><i class="fa fa-times" title="حذف"></i></button>
                                            </div>
                                        </td>
                                          <!-- Delete Modal -->
                                 <div class="modal modal-danger" id="delcoursedeploma{{ $course->id }}" tabindex="-1" role="dialog"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                    <form action="{{ route('course-deploma.destroy', $row->id) }}"  method="POST" >
                                        @csrf
                                        @method('DELETE')
                    	...
                    	<!-- Add Trainer Modal -->
		<div class="modal fade dir-rtl" id="add-tabdeploma" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
                    ...
                    <form action="{{ route('course-deploma.store') }}"  method="POST" >
                        @csrf
					<div class="modal-body text-center">
						<h3><i class="fa fa-edit "></i></h3>
						<h4>تأكيد إضافة دورة للمدرب</h4>
                        <input type="hidden" name="deploma_id" value="{{$deplom->id}}" id="">
						<div class="box-body">
							<div class="col-sm-12">
