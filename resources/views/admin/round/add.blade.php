    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="box box-primary">
                ...
                <form action="{{ route('round.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="box-body">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="round_no" value="{{ old('round_no') }}" class="form-control" id="">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="">اسم الفرع</label>
                                <select name="branch_id" class="form-control dynamic" id="">
                            ...
                            <div class="form-group">
                                ...
                                <select name="room_id" class="form-control" id="room_id">
                                    ...
                                    {{-- @foreach ($rooms as $type)
                                        <option value="{{ $type->id }}">{{ $type->room_no }}</option>
                                    @endforeach --}}
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="date" readonly name="end_date" value="{{ old('end_date') }}" class="form-control"
                                    id="">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" readonly  class="form-control" id="hours">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="discount_per" value="{{ old('discount_per') }}"
                                    class="form-control" id="">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="rent_room_fees" value="{{ old('rent_room_fees') }}"
                                    class="form-control" id="">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="certificate_fees" value="{{ old('certificate_fees') }}"
                                    class="form-control" id="">
                            </div>
                        </div>
                        <div class="col-sm-6">
