...
<div class="box">
    <div class="box-header">
        ...
        <a href="{{ route('round.create') }}" class="btn btn-info btn-lg pull-right"> اضافة </a>
            ...
            data-show-export="true" data-locale="ar-SA"  style="direction: rtl" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('round.show', $row->id) }}" class="btn btn-default"><i class="fa fa-eye" title="عرض"></i></a>
                                            <a href="{{ route('round.edit', $row->id) }}" class="btn btn-default"><i class="fa fa-edit" title="تعديل"></i></a>
                             ...
                             <div class="modal modal-danger" id="del{{ $row->id }}" tabindex="-1" role="dialog"
                                ...
                                <form action="{{ route('round.destroy', $row->id) }}"  method="POST" >
                                    @csrf
                                    @method('DELETE')
