...
<div class="row">
    ...
    <div class="col-md-10">
        ...
        <form action="{{ route('invoice.update', $row->id) }}" method="post" enctype="multipart/form-data">

            @method('PUT')
            @csrf
            <?php
            $total_fees_new = App\Models\Invoice::where('student_id', $row->student_id)->where('round_id', $row->round_id)->whereIn('payment_type_id',[101,102])->sum('total_fees_new');
    ?>
                <div class="box-body">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" readonly name="invoice_no" value="{{$row->invoice_no}}" class="form-control" id="">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="">نوع الدفع</label>
                            <select class="form-control select2" disabled name="payment_type_id" id="c3" >
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select class="form-control select2 " disabled name="branch_id" id="c2" >
                ...
                <div class="box-body">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select class=" select2 dynamic form-control" disabled name="course_id" id="course_id">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select class=" select2 round form-control" disabled name="round_id" id="round_id" >
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select class=" select2 form-control" disabled name="student_id" id="student_id" >
                ...
                <div class="box-body">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="date" readonly name="invoice_date" value="{{date('Y-m-d', strtotime($row->invoice_date))}}" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="number" readonly name="total_required_fees"  value="{{$row->total_required_fees}}" class="form-control" id="total_required_fees" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="">المبلغ المدفوع </label>
                            <input type="number" readonly name="total_paid_before" value="{{$total_fees_new}}" oninput="myFunction()" class="form-control" id="total_paid_before" >
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="">المبلغ المتبقى </label>
                            <input type="number" readonly name="total_fees_new" value="{{$row->total_fees_new}}" class="form-control" id="total_fees_new" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="">الخزنة </label>
                            <select class=" select2 form-control" disabled name="cashbox_id" id="cashbox_id" >
                    ...
                    <div class="col-sm-8">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" readonly name="notes">{{$row->notes}}</textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="box-footer">
                ...
                <a href="{{ route('current-groups.show', $row->round_id) }}" class="btn btn-danger">إلغاء</a>
            </div>
        </form>
            </div>
    </div>
